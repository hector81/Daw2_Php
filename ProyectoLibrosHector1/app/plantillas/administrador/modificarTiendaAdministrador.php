...
<form name="formularioModificaTienda" class="formularioModificaTienda" action="index.php?ctl=enviarDatosModificacionTienda"
  method="POST" style="text-align:left;"  enctype="multipart/form-data">
        <legend>Datos de la tienda a modificar</h1><br><br>
        <label for="nombreTienda">Nombre</label>
        <input type="text" value="<?php echo $value->getNombre(); ?>" name="nombreTienda" id="nombreTienda" size="40"><br>
        ...
        <input type="text" value="<?php echo $value->getTelefono(); ?>" name="telefonoTienda" id="telefonoTienda" size="40"><br><br>
        <label for="direccionTienda">Dirección</label>
        <input type="text" value="<?php echo $value->getDireccion(); ?>" name="direccionTienda" id="direccionTienda" size="40"><br><br>
        ...
        <input type="text" value="<?php echo $value->getSrcIframe(); ?>" name="srcIframe" id="srcIframe" size="40"><br><br>
