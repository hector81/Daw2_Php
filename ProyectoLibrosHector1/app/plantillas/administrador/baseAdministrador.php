   ...
   <body>
         ...
         <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
               <ul class="nav navbar-nav">
                  ...
                  <li><a href="index.php?ctl=administrarLibros">Libros</a></li>
                  <li><a href="index.php?ctl=administrarTiendas">Tiendas</a></li>
                  <li><a href="index.php?ctl=administrarAlmacen">Almacen</a></li>
                  <li><a href="index.php?ctl=administrarUsuarios">Usuarios</a></li>
                  <li><a href="#">Ventas</a></li>
                  <li class="dropdown">
                     <a href="#"  class="dropdown-toggle" data-toggle="dropdown">Categorias<span class="caret"></span></a>
                     <ul class="dropdown-menu">
                        <li><a href="index.php?ctl=verCategoriasAdministrador">Categorias</a></li>
                        <li><a href="index.php?ctl=verSubCategoriasAdministrador">Subcategorias</a></li>
                     </ul>
                  </li>
                           ...
                           <div class="modal-dialog">
                              ...
                              <div class="modal-content">
                                 ...
                                 <div class="modal-body">
                                    <form name="accederUsuarios" class="formAccederUsuarios" method="POST" action="index.php?ctl=inicioUsuario">
                                       <h2>Formulario</h2>
      ...
      <div class="container text-center">
         ...
         <div class="col-sm-12 col-md-9 col-lg-9 content-padding">
            ...
            <?= $contenido ?>
            <hr><p class="list-group-item-text"><a href="index.php?ctl=inicioAdministrador">Inicio</a></p>
         </div>
      ...
      <footer class="footer-basic-centered">
         <p class="footer-links">
            <a href="index.php?ctl=inicioAdministrador">Inicio</a>
            <a href="index.php?ctl=administrarLibros">Libros</a>
            <a href="index.php?ctl=administrarTiendas">Tiendas</a>
            <a href="index.php?ctl=administrarUsuarios">Usuarios</a>
            <a href="#">Ventas</a>
         </p>
