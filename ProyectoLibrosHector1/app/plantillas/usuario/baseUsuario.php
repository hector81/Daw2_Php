   ...
   <body>
      <nav class="navbar navbar-inverse">
         <div class="container-fluid">
            <a class="navbar-brand" href="#"><img class="imagenI" src="Imagenes/logo.png"></a>
            <div class="collapse navbar-collapse" id="myNavbar">
               <ul class="nav navbar-nav">
                  <li class="active"><a href="index.php?ctl=inicioUsuario">Home</a></li>
                  <!-- index.php?ctl=inicioUsuario -->
                  <li><a href="index.php?ctl=librosPorCategoriaUsuario">Libros por materia</a></li>
      ...
      <div class="container text-center">
         <div class="row">
            ...
            <div class="col-sm-12 col-md-9 col-lg-9 content-padding">
               ...
               <?= $contenido ?>
               <a href="index.php?ctl=inicioUsuario">Inicio</a>
            </div>
      ...
      <footer class="footer-basic-centered">
         <p class="footer-links">
            <a href="index.php?ctl=inicioUsuario">Inicio</a>
            <a href="index.php?ctl=librosPorCategoriaUsuario">Libros por materia</a>
            <a href="#">Tiendas</a>
            <a href="index.php?ctl=busqueda">Busqueda</a>
            <a href="#">Contacto</a>
            <a href="#">Carrito</a>
