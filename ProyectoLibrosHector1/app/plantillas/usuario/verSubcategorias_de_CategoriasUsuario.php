...
foreach ($subCategorias as $key1 => $value1) {
    ...
    echo '<form name="verLibrosPorSubCategoriaUsuario" class="verLibrosPorSubCategoriaUsuario" method="POST" action="index.php?ctl=verLibrosPorSubCategoriaUsuario">';
    echo '<ul>';
        ...
        echo 'Libros disponibles : '.$NUMERO_LIBROS.'</span>';
             echo '</br><p class="list-group-item-text">Descripción:'.$Descripcion;
              echo '</p></a>';
        echo '<button type="submit" class="btn btn-default" name="verLibrosPorSubCategoriaUsuario">Ver libros por subcategorias</button>';
