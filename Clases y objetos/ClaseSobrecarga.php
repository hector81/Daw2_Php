			...
			class PropertyTest
					{
						...
						public function __set($name, $value) /* aqui sobrecarga el metodo set */
						{
							echo "Estableciendo '$name' a '$value'\n";
							$this->data[$name] = $value;
						}

						public function __get($name)/* en el indice name mete el valor value de la anterior linea  $this->data[$name] = $value; */
						{
							echo "Consultando '$name'\n"; /* comprueba que el nombre exista en el indice */
							if (array_key_exists($name, $this->data)) {
								return $this->data[$name];  /* si lo tiene lo devuelve */
							}

							$trace = debug_backtrace();
							trigger_error(				/* y si no lanza un error*/
