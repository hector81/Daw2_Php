	...
	<div id="contenedor">
		...
		<div id="formulario">
			...
			class pedidoPizzaNet {
				...
				public function __construct($IVA,$euros,$totalFacturaIVA,$tipoPizza,$sizePizza,$masaPizza,$extrasPizzas,$numeroPizzas,$nombreCliente,$direccionCliente,$telefonoCliente)
				  {
					$this->IVA=$IVA;
					$this->euros=$euros;
					$this->totalFacturaIVA=$totalFacturaIVA;
